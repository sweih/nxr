...
Array.extend({
	...
	*/
	...
	Property: associate
		...
		and the current smoothgallery of the array.
...
Element.extend({
	...
	*/
	...
	clone: function(smoothgallerys){
		var el = this.cloneNode(smoothgallerys !== false);
		return $(el);
	},
		...
		if (type == 'domready'){
			if (this.loaded) fn();
				...
				if (document.readyState && this.khtml){ //safari and konqueror
					...
					document.addEvent("DOMsmoothgalleryLoaded", domReady);
				}
			}
		}
...
/*
Class: Fx.Slide
	The slide effect; slides an element in horizontally or vertically, the smoothgallerys will fold inside. Extends <Fx.Base>, inherits all its properties.
