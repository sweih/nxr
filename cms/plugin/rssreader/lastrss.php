...
class lastRSS {
	...
	/**	 
	 * Get a file through proxy.
	 * @author: sweih, found at php.net
	 */
	function getThroughProxy($myfiles, $proxyhost="0.0.0.0", $proxyport=0)	{
  		$errno="";
  		$errstr="";
	...
	function Parse ($rss_url) {
		...
		if ($this->proxy != "") {
			$temp = $this->getThroughProxy($rss_url, $this->proxy, $this->proxyport);	
			$rss_content = $temp['content'];
		} else {
