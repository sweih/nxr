<?php
	...
	// +------------------------------------------------------------------------+
	//
	// $Id: TestDecorator.php,v 1.2 2003/08/12 23:15:30 sven_weih Exp $
	//
	...
	class PHPUnit_TestDecorator {
		...
		* @access public
		*/
		function basicRun(&$result) { $this->_test->run($result); }
		...
		* @access public
		*/
		function countTestCases() { return $this->_test->countTestCases(); }
		...
		* @access public
		*/
		function toString() { return $this->_test->toString(); }
	}
?>