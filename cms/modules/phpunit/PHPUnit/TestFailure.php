<?php
	...
	// +------------------------------------------------------------------------+
	//
	// $Id: TestFailure.php,v 1.2 2003/08/12 23:15:30 sven_weih Exp $
	//
	...
	class PHPUnit_TestFailure {
		...
		* @access public
		*/
		function &failedTest() { return $this->_failedTest; }
		...
		* @access public
		*/
		function &thrownException() { return $this->_thrownException; }
