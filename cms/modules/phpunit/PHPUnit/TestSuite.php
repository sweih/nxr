<?php
	...
	// +------------------------------------------------------------------------+
	//
	// $Id: TestSuite.php,v 1.2 2003/08/12 23:15:30 sven_weih Exp $
	//
	...
	class PHPUnit_TestSuite {
		...
		* @access public
		*/
		function addTest(&$test) { $this->_tests[] = $test; }
		...
		* @access public
		*/
		function runTest(&$test, &$result) { $test->run($result); }
		...
		* @access public
		*/
		function testCount() { return sizeof($this->_tests); }
		...
		* @access public
		*/
		function &tests() { return $this->_tests; }
