<?php
	...
	// +------------------------------------------------------------------------+
	//
	// $Id: TestResult.php,v 1.2 2003/08/12 23:15:30 sven_weih Exp $
	//
	...
	class PHPUnit_TestResult {
		...
		* @access public
		*/
		function addPassedTest(&$test) { $this->_passedTests[] = $test; }
		...
		* @access public
		*/
		function errorCount() { return sizeof($this->_errors); }
		...
		* @access public
		*/
		function failureCount() { return sizeof($this->_failures); }
		...
		* @access public
		*/
		function &failures() { return $this->_failures; }
		...
		* @access public
		*/
		function &passedTests() { return $this->_passedTests; }
		...
		* @access public
		*/
		function runCount() { return $this->_runTests; }
		...
		* @access public
		*/
		function shouldStop() { return $this->_stop; }
		...
		* @access public
		*/
		function toHTML() { return '<pre>' . htmlspecialchars($this->toString()). '</pre>'; }
