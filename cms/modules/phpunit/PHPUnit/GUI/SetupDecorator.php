<?php
	...
	// +------------------------------------------------------------------------+
	//
	// $Id: SetupDecorator.php,v 1.2 2003/08/12 23:15:30 sven_weih Exp $
	//
	...
	*/
	class PHPUnit_GUI_SetupDecorator {
		...
		*
		*/
		function PHPUnit_GUI_SetupDecorator(&$gui) { $this->_gui = $gui; }

		/**
		*   just forwarding the action to the decorated class.
		*
		*/
		function show($showPassed = true) { $this->_gui->show($showPassed); }
