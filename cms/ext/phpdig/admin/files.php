...
for ($n = 0; $n<$num; $n++) {
    ...
    if (!$locked) {
        print "<a href='files.php?sid=$sid&site_id=$site_id&amp;spider_id=$spider_id&amp;sup=1#$aname2'><img src='no.gif' width='10' height='10' border='0' align='middle' alt='' /></a>&nbsp;\n";
        print "<a href='files.php?site_id=$site_id&amp;spider_id=$spider_id&amp;spider=1&amp;sid=$sid' ><img src='yes.gif' width='10' height='10' border='0' align='middle' alt='' /></a>&nbsp;\n";
    }
