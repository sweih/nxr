...
<select class="phpdigSelect" name="site_ids[]" multiple="multiple" style="width:200px;" size="10">
<?php
...
<p class='grey'>
<a href="cleanup_engine.php?sid=<?php echo $sid;?>"><?php print phpdigMsg('clean')." ".phpdigMsg('t_index'); ?></a><br/>
<a href="cleanup_keywords.php?sid=<?php echo $sid;?>"><?php print phpdigMsg('clean')." ".phpdigMsg('t_dic'); ?></a><br/>
<a href="cleanup_common.php?sid=<?php echo $sid;?>"><?php print phpdigMsg('clean')." ".phpdigMsg('t_stopw'); ?></a><br/>
<a href="cleanup_dashes.php?sid=<?php echo $sid;?>"><?php print phpdigMsg('clean')." ".phpdigMsg('t_dash'); ?></a><br/>
<a href="limit_update.php?sid=<?php echo $sid;?>"><?php print phpdigMsg('upd_sites'); ?></a><br/>
<a href="statistics.php?sid=<?php echo $sid;?>"><?php print phpdigMsg('statistics') ?></a><br/>
<a href="stop_spider.php?stop=1&sid=<?php echo $sid;?>"><?php print phpdigMsg('StopSpider') ?></a><br/>
</p>
</td>
</tr>
<tr>
