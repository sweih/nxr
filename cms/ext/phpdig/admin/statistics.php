...
<p class='grey'>
<a href="statistics.php?sid=<?php echo $sid;?>&type=mostkeys"><?php phpdigPrnMsg('mostkeywords') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=mostpages"><?php phpdigPrnMsg('richestpages') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=mostterms"><?php phpdigPrnMsg('mostterms') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=largestresults"><?php phpdigPrnMsg('largestresults') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=mostempty"><?php phpdigPrnMsg('mostempty') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=lastqueries"><?php phpdigPrnMsg('lastqueries') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=responsebyhour"><?php phpdigPrnMsg('responsebyhour') ?></a>
<br /><a href="statistics.php?sid=<?php echo $sid;?>&type=lastclicks"><?php phpdigPrnMsg('lastclicks') ?></a>
</p>
