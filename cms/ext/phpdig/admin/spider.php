...
<h3><?php phpdigPrnMsg('spidering'); ?><a href="stop_spider.php?stop=1&sid=<?php echo $sid; ?>" target="_top"> [<?php phpdigPrnMsg('StopSpider'); ?>]</a></h3>
<?php
}
else {
...
if (isset($mode) && isset($site_id) && $mode == 'small') {
    print '<br /><a href="update_frame.php?sid='.$sid.'&site_id='.$site_id.'" target="contentset">['.phpdigMsg('back').']</a> '.phpdigMsg('to_update').'.';
}
?>
</body>
</html>
