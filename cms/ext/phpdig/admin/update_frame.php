...
if ($delete) {
    ...
    header ("location:index.php".$message.'&sid=$sid');
    exit();
}
...
<frameset cols="50%,50%">
<frame src="update.php?site_id=<?php print $site_id."&sid=".$sid; ?>" name="tree" frameborder="0" noresize="noresize" />
<frame src="files.php?sid=<?php echo $sid; ?>" frameborder="0" name="files" />
