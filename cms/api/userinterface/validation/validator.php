 ...
 **********************************************************************/
  ...
  class Validator {
  	 ...
  	 * @param string Message that will be displayed on error at the input field.
  	 * @param string Message that will be displayed on the top of the form on error.
  	 */ 	 
  	function Validator($name, $fieldErrorMessage="", $formErrorMessage="") {
  	...
  	/**
  	 * internal.
  	 * Function us called by the validate method, to indicate an error has happened.
  	 */
  	function throwException() {
  	  global $errors, $formErrors;
  	  $errors.="-".$this->name;
  	  $formErrors.=$this->formErrorMessage; 	
