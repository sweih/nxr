<?
	...
	* @version 1.00
	*/
	class LinkIconButtonInCell extends LinkIconButton {
		...
		* @param string $action JS action, that is to be performed, when button is clicked
		  ...
		  */
		function LinkIconButtonInCell($name, $value, $icon, $style, $type = "button", $action = "", $formname = "form1", $cells = 1) { LinkIconButton::LinkIconButton($name, $value, $icon, $style, $type, $action, $formname, $cells); }
