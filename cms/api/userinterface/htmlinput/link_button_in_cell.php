<?
	...
	* @version 1.00
	*/
	class LinkButtonInCell extends LinkButton {
		...
		* @param string $action JS action, that is to be performed, when button is clicked
		  ...
		  */
		function LinkButtonInCell($name, $value, $style, $type = "button", $action = "", $formname = "form1", $cells = 1) { LinkButton::LinkButton($name, $value, $style, $type, $action, $formname, $cells); }
