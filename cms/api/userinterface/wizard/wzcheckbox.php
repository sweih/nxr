 ...
 *
 *      $Id: wzcheckbox.php,v 1.1 2004/04/01 18:07:40 fabian_koenig Exp $ *
 *
  ...
  class WZCheckbox extends WZO {
  	...
  	function draw() {
  		...
  		for ($i=0; $i < count($this->nameValueArray); $i++) {
  		  ...
  		  echo "<input type=\"checkbox\" name=\"$this->name\" id=\"$this->name\" value=\"".$this->nameValueArray[$i][1]."\" $checked >&nbsp;";
  		  echo "</td>";  		  
